namespace FinalProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FinalProject.Dal.GeneralDbContext>
    {
        ...
        protected override void Seed(FinalProject.Dal.GeneralDbContext context)
        {
            ...
            new Review() { ReviewID = 1, BusinessID = 6, Author ="mosik@gmail.com",Date= new DateTime(2003,3,12), Description="Great place"},
            new Review() { ReviewID = 2, BusinessID = 6, Author = "avi@gmail.com", Date = new DateTime(2004, 5 , 2), Description = "Awesome" },
            new Review() { ReviewID = 3, BusinessID = 6, Author = "david.re@gmail.com", Date = new DateTime(2000, 3 , 3), Description = "Nothing to say" },
            new Review() { ReviewID = 4, BusinessID = 6, Author = "Reuven@gmail.com", Date = new DateTime(2010, 5 , 6), Description = "Average"},
            new Review() { ReviewID = 5, BusinessID = 6, Author = "dudu@gmail.com", Date = new DateTime(2012, 6 , 9), Description = "Nice" },
            new Review() { ReviewID = 6, BusinessID = 1, Author = "anni@gmail.com", Date = new DateTime(2017, 7 , 6), Description = "Recommanded"},
            new Review() { ReviewID = 6, BusinessID = 1, Author = "shuster@gmail.com", Date = new DateTime(2017, 4 , 9), Description = "Not Recommanded"},
            new Review() { ReviewID = 7, BusinessID = 1, Author = "levi.pingi@gmail.com", Date = new DateTime(2016, 10 , 10), Description = "Cool"},
            new Review() { ReviewID = 7, BusinessID = 2, Author = "brainiac@gmail.com", Date = new DateTime(2012, 10 , 12), Description = "Terrible!"},
            new Review() { ReviewID = 8, BusinessID = 2, Author = "crazyReviewer@gmail.com", Date = new DateTime(2009, 3 , 11), Description = "Not so good" },
            new Review() { ReviewID = 9, BusinessID = 3, Author = "toto@gmail.com", Date = new DateTime(2003, 12 , 1), Description = "Very nice" },
            new Review() { ReviewID = 10, BusinessID = 3, Author = "meni@gmail.com", Date = new DateTime(2017, 3 , 3), Description = "Bad service" },
            new Review() { ReviewID = 11, BusinessID = 3, Author = "JackBlack@gmail.com", Date = new DateTime(2017, 4 , 6), Description = "Great website" },
            new Review() { ReviewID = 12, BusinessID = 3, Author = "TamiCohen@gmail.com", Date = new DateTime(2017, 4 , 6), Description = "Great location" },
            new Review() { ReviewID = 13, BusinessID = 4, Author = "arik.zeevi@gmail.com", Date = new DateTime(2016, 6 , 7), Description = "Bad customer service" },
            new Review() { ReviewID = 14, BusinessID = 4, Author = "static@gmail.com", Date = new DateTime(2013, 5 , 9), Description = "Would recommand to my friends" },
            new Review() { ReviewID = 15, BusinessID = 5, Author = "ben.el@gmail.com", Date = new DateTime(2010, 3 , 10), Description = "Bad managment" },
            new Review() { ReviewID = 16, BusinessID = 5, Author = "dudu@gmail.com", Date = new DateTime(2014, 2 , 11), Description = "Love it!" },
            new Review() { ReviewID = 17, BusinessID = 5, Author = "shlomi_shabat@gmail.com", Date = new DateTime(2014, 9 , 5), Description = "Great place" },
            new Review() { ReviewID = 18, BusinessID = 5, Author = "jenia@gmail.com", Date = new DateTime(2015, 11 , 6), Description = "Lack of service" },
            new Review() { ReviewID = 19, BusinessID = 5, Author = "tovi.alper@gmail.com", Date = new DateTime(2014, 12 , 4), Description = "Don't answer to phones" }
          );
