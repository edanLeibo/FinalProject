namespace FinalProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FinalProject.Dal.GeneralDbContext>
    {
        ...
        protected override void Seed(FinalProject.Dal.GeneralDbContext context)
        {
            ...
            new Business() { BusinessID = 6, Type = "Food", StreetAddress = "12/2 HaYarkon st.", City = "Tel Aviv", Website = "www.cafeJoe.co.il", Photo = "", Description = "Coffee bar", Owner = "Yogev Ohayon", BusinessName = "Cafe Joe", Video = "", PhoneNumber = "03-9432211" },
            new Business() { BusinessID = 1, Type = "Food", StreetAddress = "12/2 Hashalom st.", City = "Haifa", Website = "www.cafecafe.co.il", Photo = "", Description = "Coffee bar", Owner = "David Colman", BusinessName = "CafeCafe", Video = "", PhoneNumber = "03-4788322" },
            new Business() { BusinessID = 2, Type = "Food", StreetAddress = "15/1 Hahashmonaim st.", City = "Jerusalem", Website = "www.shufersal.co.il", Photo = "", Description = "The largest supermarket chain in Israel", Owner = "Rami Tamir", BusinessName = "Shufersal", Video = "", PhoneNumber = "08-5784455" },
            new Business() { BusinessID = 3, Type = "Internet", StreetAddress = "111/32 Tishbi st.", City = "Sderot", Website = "www.wix.co.il", Photo = "", Description = "A cloud-based web development platform that was first developed and popularized", Owner = "Moshe Levi", BusinessName = "Wix", Video = "", PhoneNumber = "02-9234452" },
            ...
            new Business() { BusinessID = 5, Type = "Construction", StreetAddress = "192/32 Rotenberg st.", City = "Ra'anana", Website = "www.accsal.com", Photo = "", Description = "Coffee bar", Owner = "Rami Cohen", BusinessName = "Accsal Construction", Video = "", PhoneNumber = "03-6555902" }
          );
